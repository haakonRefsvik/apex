...
val md_theme_light_surface = Color.White  // overflate på
val md_theme_light_secondaryContainer = Color(0xFFCFE9D9) // ikke i bruk
...
val md_theme_light_surfaceVariant = Color(0xFFDBE5DD) // IKKe i bruk
